...
//Data sizes
#define IEPS_SYSTEMSTATE_SIZE 	  23
#define IEPS_HKDATAMB_SIZE        46
#define IEPS_HKDATACDB_SIZE       32
#define IEPS_LOSTATE3V3_SIZE      12
#define IEPS_LOSTATE5V_SIZE       12
#define IEPS_LOSTATEBV_SIZE       8
#define IEPS_LOSTATEHV_SIZE       18
#define IEPS_LOSTATE_MAX_SIZE     20			// message size with maximum amount of channels possible, given the fact the bitflag channel encoding is 8-bits
...
typedef union __attribute__ ((__packed__)) _ieps_lostate_t
{
    ...
    struct __attribute__ ((__packed__))
    {
    	ieps_obus_channel_t pgood;			///< bitflag output bus channel power good indication; 1 = bus voltage 90% of target voltage at minimum
    	ieps_obus_channel_t los;			///< bitflag output bus channel latch-off state indication; 1 = latched-off due to overcurrent
