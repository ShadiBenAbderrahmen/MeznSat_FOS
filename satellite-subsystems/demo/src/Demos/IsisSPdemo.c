...
static Boolean SolarPanel_Temperature(void)
{
	...
	error = IsisSolarPanel_getTemperature(slave3_spi, &paneltemp[0]);
	error = IsisSolarPanel_getTemperature(slave4_spi, &paneltemp[1]);
	error = IsisSolarPanel_getTemperature(slave5_spi, &paneltemp[2]);
	error = IsisSolarPanel_getTemperature(slave6_spi, &paneltemp[3]);
	error = IsisSolarPanel_getTemperature(slave7_spi, &paneltemp[4]);
